...
export default function CounterSection() {
    ...
    const stats = [
        {
            icon: (
                <Image src="/book.svg" alt="Book icon" width={48} height={48} className="w-12 h-12 max-sm:w-10 max-sm:h-10" loading="lazy" />
            ),
            number: 800,
            suffix: "+",
        ...
        {
            icon: (
                <Image src="/reload.svg" alt="Reload icon" width={48} height={48} className="w-12 h-12 max-sm:w-10 max-sm:h-10" loading="lazy" />
            ),
            number: 100,
            suffix: "+",
        ...
        {
            icon: (
                <Image src="/growth.svg" alt="Growth icon" width={48} height={48} className="w-12 h-12 max-sm:w-10 max-sm:h-10" loading="lazy" />
            ),
            number: 200,
            suffix: "+",
